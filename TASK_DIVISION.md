...
- `frontend/js/techbot-widget.js`
- `frontend/css/techbot-widget.css`
- `backend/.env`

Task:
Own Stripe Checkout backend, payment confirmation, Together AI TechBot backend route, and the Deep Chat launcher/widget UI.
